...
export const createSettingsStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  backButton: { width: 38, height: 38, justifyContent: 'center', alignItems: 'center', borderRadius: 19 },
  backIcon: { fontSize: 24, color: colors.background === '#12100D' ? '#F7F2EA' : colors.text },
  title: { flex: 1, fontSize: 30, fontWeight: '800', color: colors.background === '#12100D' ? '#F7F2EA' : colors.text, textAlign: 'center' },
  tabBar: {
    flexGrow: 0,
  },
  tabBarContent: {
  ...
  modal: { backgroundColor: colors.surface, borderRadius: 18, padding: 20, width: '85%', maxHeight: '60%' },
